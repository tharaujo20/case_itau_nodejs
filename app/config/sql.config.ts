export default () => ({
  sql: {
    createTableClientes: `CREATE TABLE clientes( id INTEGER PRIMARY KEY AUTOINCREMENT, nome TEXT NOT NULL, email TEXT NOT NULL UNIQUE, saldo FLOAT NOT NULL DEFAULT 0 )`,
